...
def main():
    ...
    if navigator == "Tweet Frequency":
        df = read_pkl(label=menu, path="../data/", data_prefix="_tweet_freq.pkl")
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """Dagligt antal tweets indeholdende søgeordene. 
        ...
        with st.expander("Caption (EN)"):
            st.write(
                """Daily number of tweets containing the keywords. 
        ...
        df = read_pkl(label=menu, path="../data/", data_prefix="_sentiment.pkl")
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """Gennemsnitlig daglig sentiment af tweets der indeholder søgeordnene. 
        ...
        with st.expander("Caption (EN)"):
            st.write(
                """Average daily sentiment score of tweets containing the keywords. 
        ...
        df = read_pkl(label=menu, path="../data/", data_prefix="_hash.pkl")
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """Hyppigste hashtags brugt i tweets der indeholder søgeordene.
               """
            )

        with st.expander("Caption (EN)"):
            st.write(
                """The most frequently used hashtags in tweets containing the keywords. 
               """
            )

    elif navigator == "Word Frequency":
        df = read_pkl(label=menu, path="../data/", data_prefix="_w_freq.pkl")
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """De hyppigste ord brugt i tweets der indeholder søgeordene. 
        ...
        with st.expander("Caption (EN)"):
            st.write(
                """The most frequently used words in tweets containing the keywords. 
        ...
        df = read_pkl(label=menu, path="../data/", data_prefix="_bigrams.pkl")

        w_freq = read_pkl(label=menu, path="../data/", data_prefix="_w_freq.pkl")

        value = st.slider(
            "Select the number of bigrams", min_value=1, max_value=30, value=30, step=1
        )
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """De 30 hyppigste ordpar (bigrams) i tweets der indeholder søgeordene. 
        ...
        with st.expander("Caption (EN)"):
            st.write(
                """The 30 most common word-pairs (bigrams) in the tweets containing the keywords. 
        ...
        with st.expander("Caption (DA)"):
            st.write(
                """Wordcloud der visualiserer de hyppigste ord i tweets der indeholder søgeordene. 
        ...
        with st.expander("Caption (EN)"):
            st.write(
                """Wordcloud visualizing frequency of words in the tweets containing the keywords. 
